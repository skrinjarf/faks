/*
 torus3.c ---  vec definirana Torus funkcija rotira oko y=x osi ali pomaknut da ju dodiruje
 * Koristeci GLUT procedure nacrtajte žicani model torusa u ortografskoj projekciji, koji rotira oko zadane osi
*/
#include <math.h>		// For math routines (such as sqrt & trig).
#include <stdio.h>
#include <stdlib.h>		// For the "exit" function
#include <GL/glut.h>		// For the "exit" function
#include <GL/gl.h>
...
void drawScene(void)
{
	...
	glTranslatef( -0.5, 0.5, 0.0 );					// Translate rotation center from origin
	glRotatef( CurrentAngle, 1.0, 1.0, 0.0 );
								// Rotate through animation angle
	glTranslatef( 0.5, -0.5, 0.0 );				// Translate rotation center to origin

	
     // glPushMatrix();  
       
        glColor3f( 1.0, 1.0, 1.0 );			
        glutWireTorus( 0.2, 1.0, 10, 25 );
      //glPopMatrix();
...
void resizeWindow(int w, int h)
{
    ...
    glLoadIdentity();
    glOrtho( windowXmin, windowXmax, windowYmin, windowYmax, -5, 5 );
