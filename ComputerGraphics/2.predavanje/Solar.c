...
static void Animate(void)
{
	...
	if ( singleStep ) {					//za single step napravi samo jedan korak
		spinMode = GL_FALSE;
	}
...
static void ResizeWindow(int w, int h)
{
    ...
    glLoadIdentity();
    gluPerspective( 60.0, aspectRatio, 1.0, 30.0 );  //(kut gornje i doljnje osi, omjer visine i sirine, jos nesto sta ce rec kad budemo radili projekcije ( 3. predavanje ? ) 
